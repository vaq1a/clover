...
//   gulp.watch(['src/_tpl_*.html', 'src/__*.html', 'src/includes/**/*.json', 'src/includes/**/*.html', 'src/includes/**/*.svg'], gulp.parallel('html:buildAllPages'));
//   gulp.watch('src/sass/**/*.+(scss|sass)', gulp.parallel('sassCompilation'));
// });

// gulp.task('default', gulp.parallel('watch', 'createCustomModernizr', 'browserSync', 'html:buildAllPages', 'sassCompilation', 'mergeCssLibs', 'copyLibsScriptsToJs'));
